...
Tags: support, Maintanance, WP, WPorb, Site Information, System Information, Site Info, System Info, Info, Theme Info, Theme Information, Site Check, System Check 
...
== Description ==
Get useful information about your website such as php/mysql version, wordpress version, active theme and plugins etc.
...
= Features =
   * WP Version, URL and Language
   * Debug Mode and Memory Limit 
   * PHP, MySQL and cURL Version 
   * PHP Time Limit and Max Post Size & Max Upload Size
   * PHP Error File and Upload Directory Location 
   * Current Theme Name, Version and child theme 
   * Active plugins list, version and author
